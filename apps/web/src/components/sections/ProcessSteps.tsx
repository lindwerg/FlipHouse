...
const STEPS: readonly Step[] = [
  ...
  {
    n: 'ПРОХОД 02',
    t: 'Перевод в вертикаль',
    d: 'Кадрирование держит спикера в кадре, пересобирая 16:9 в чистый 9:16.',
  },
  {
    n: 'ПРОХОД 03',
    t: 'Прожечь субтитры',
    d: 'Субтитры по словам в стиле бренда, вшитые в клип и редактируемые до экспорта.',
  },
  {
    n: 'ПРОХОД 04',
    t: 'Ранжировать и отдать',
    d: 'Каждый клип получает оценку виральности: публикуй сильное первым и начинай зарабатывать. Можно добавить нативный рекламный слот и получать оплату за показы.',
  },
];
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1600px] px-[var(--space-margin)]">
        ...
        <ol data-reveal-group="rise" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {STEPS.map(step => (
            <li
              key={step.n}
              data-reveal-item
            ...
            >
              <span className="mb-8 block font-mono text-sm font-semibold tracking-wide text-[var(--pop)] md:mb-10">
                {step.n}
              </span>
              <h3
