...
| **P1** | Веб-каркас: auth, биллинг, лендинг с hero-дропзоной | Форк SaaS-Boilerplate (Next.js + Clerk + Drizzle) на Railway, крипто-биллинг за `PaymentProvider` (USDT-баланс: PAYG $0.25/мин + подписка с лимитом минут, Старт/Актив/Студия; Stripe/ЮKassa убраны), creator/advertiser RBAC, dark AI-tech лендинг с hero-дропзоной (Kibo + AI Elements над shadergradient), scroll-сторителлинг. | P0 | 17 | [P1-web-auth-billing-landing.md](./roadmap/P1-web-auth-billing-landing.md) | A: форк поднят, тесты зелёные · B: oklch-токены + dark-тема · C: hero-дропзона все состояния · D: лендинг целиком · E: 2 типа аккаунта + онбординг · F: крипто-баланс (депозит USDT→PAYG/подписка) + webhook · G: staging deploy, e2e зелёные |
