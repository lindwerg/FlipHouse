...
| **P1** | Веб-каркас: auth, биллинг, лендинг с hero-дропзоной | Форк SaaS-Boilerplate (Next.js + Clerk + Drizzle) на Railway, биллинг за `PaymentProvider` (РФ-оператор TBD, Stripe не работает в РФ), creator/advertiser RBAC, dark AI-tech лендинг с hero-дропзоной (Kibo + AI Elements над shadergradient), scroll-сторителлинг. | P0 | 17 | [P1-web-auth-billing-landing.md](./roadmap/P1-web-auth-billing-landing.md) | A: форк поднят, тесты зелёные · B: oklch-токены + dark-тема · C: hero-дропзона все состояния · D: лендинг целиком · E: 2 типа аккаунта + онбординг · F: `PaymentProvider` checkout + webhook · G: staging deploy, e2e зелёные |
