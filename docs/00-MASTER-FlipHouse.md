...
| **Биллинг / выплаты** | Stripe Connect (выплаты креаторам, бюджеты рекламодателей) | коммерч. | `web` |
...
- Stripe Connect песочница, Clerk auth.
