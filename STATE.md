...
- ⬜ Шаг P1.16 ← **СЕЙЧАС** (сквозные e2e signup→пополнение→дашборд + визуальная регрессия 320/768/1024/1440 + Lighthouse-гейт → затем 🛑 ЧЕКПОИНТ G)
- ⬜ Шаг P1.17
