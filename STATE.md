...
- ⬜ Шаг P1.13.1 [NEW · FOUNDER EDIT 2026-06-16 — реальный on-chain TRON ДО деплоя: HD-кошелёк per-user (BIP44 m/44'/195'/0'/0/index из TRON_HD_MNEMONIC) + последовательный deposit_index (миграция 0003) + реальный TronGrid-поллер source.tron.ts (Nile testnet, fetch замокан в тестах); ДЕПОЗИТНЫЙ путь, createPayout→P5; 🛑 ЧЕКПОИНТ F идёт ПОСЛЕ этого шага]
- ⬜ Шаг P1.14
- ⬜ Шаг P1.15
- ⬜ Шаг P1.16
- ⬜ Шаг P1.17
