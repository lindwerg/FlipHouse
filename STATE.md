...
- ✅ Шаг P1.13 · ded8635 · 2026-06-16 [🛑 ОСТАНОВ НА ЧЕКПОИНТЕ F] [on-chain TRON deposit watcher: credit() идемпотентен по txid + processTransfers (фильтр USDT/confirmations≥19/маппинг address→userId/фактическая on-chain сумма) + runWatcherTick (курсор Redis/in-mem) + getOrCreateDepositAddress персист + миграция 0002 partial-unique на deposit_address; web 116 тестов, watcher+balance 100% coverage, гейты зелёные]
- ⬜ Шаг P1.14
- ⬜ Шаг P1.15
- ⬜ Шаг P1.16
- ⬜ Шаг P1.17
